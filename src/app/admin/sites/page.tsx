...
export default function WebsiteManagement() {
  ...
  const runTestHarness = () => {
    ...
    setTimeout(() => {
      ...
      db.addNotification("SUCCESS", "Section 16 Booking Attribution Test Harness executed. 100% of test cases passed.");
    }, 1500);
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex space-x-3 self-end sm:self-auto">
          <button
            ...
            className="flex items-center space-x-1.5 bg-brand-cream border border-brand-blush hover:border-brand-plum text-brand-plum px-3 py-2.5 rounded-lg text-xs font-bold transition-all focus:outline-none"
          >
        ...
        <form onSubmit={handleAddSite} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. Megs Connection Blog"
          ...
          <div>
            ...
            <input
              ...
              placeholder="https://megsbrass.com/stays"
              className="w-full px-3 py-2 bg-brand-bg border border-brand-blush rounded-lg text-sm focus:outline-none"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                placeholder="widget_megs_stays_01"
                className="w-full px-3 py-2 bg-brand-bg border border-brand-blush rounded-lg text-sm focus:outline-none"
              />
            </div>
            <div>
      ...
      >
        {runningTests ? (
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3 bg-emerald-50 border border-emerald-200 p-4 rounded-xl text-emerald-800 text-xs leading-relaxed">
              <CheckCircle size={20} className="shrink-0 text-emerald-600" />
              <div>
                <p className="font-bold text-sm">Attribution Test Success!</p>
                <p className="mt-0.5">The engine parsed all 3 test payloads, matched the criteria, and resolved the correct Site ID and Partner ID targets.</p>
              </div>
            </div>
